...
$g_h_CtrlHnd_AccountList = GUICtrlGetHandle($g_i_CtrlID_AccountList)
_GUICtrlListView_SetExtendedListViewStyle($g_h_CtrlHnd_AccountList, BitOR($LVS_EX_FULLROWSELECT, $LVS_EX_GRIDLINES, $LVS_EX_CHECKBOXES, $LVS_EX_DOUBLEBUFFER))
